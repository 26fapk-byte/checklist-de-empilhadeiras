...
export default function Dashboard() {
  ...
  const handleCreateEquipment = async () => {
    ...
    try {
      ...
      setNotification({ message: 'NÃ£o foi possÃ­vel cadastrar no Supabase.', type: 'error' });
    }
  };
...
<<<<<<< HEAD
  const handleRemoveEquipment = async (id: string) => {
    try {
      ...
      setNotification({ message: 'NÃ£o foi possÃ­vel remover no Supabase.', type: 'error' });
    }
=======
...
<<<<<<< HEAD
          ...
          <p className="text-sm text-[#475569] max-w-2xl mt-1">VisÃ£o gerencial de produtividade, ativos e auditorias da operaÃ§Ã£o TKF LogiCheck.</p>
=======
...
>>>>>>> baeeec2 (fix: normalize dashboard terminology to checklist system)
      ...
      <section className="tkf-card p-4 grid gap-3 sm:grid-cols-3">
        <div>
          <label className="tkf-label">PerÃ­odo</label>
...
<<<<<<< HEAD
        <article className="tkf-card p-5">
          <p className="text-[10px] font-semibold uppercase tracking-[0.24em] text-[#64748B]">InspeÃ§Ãµes totais</p>
=======
...
<<<<<<< HEAD
        <article className="tkf-card p-5">
          <p className="text-[10px] font-semibold uppercase tracking-[0.24em] text-[#64748B]">SaÃºde da Frota</p>
          <h2 className="mt-2 text-xl font-bold text-[#0F172A]">Empilhadeiras crÃ­ticas</h2>
=======
        <article className="rounded-3xl border border-[#E2E8F0] bg-white p-5 shadow-sm">
...
<<<<<<< HEAD
                className="tkf-input"
                placeholder="Empilhadeira elÃ©trica Toyota 8FBRE16S"
=======
...
<<<<<<< HEAD
                className="tkf-input"
                placeholder="Empilhadeira retrÃ¡til"
=======
                className="w-full rounded-2xl border border-[#E2E8F0] bg-[#F8FAFC] px-4 py-3 text-sm text-[#0F172A] focus:border-[#1E3A8A] focus:outline-none focus:ring-2 focus:ring-[#1E3A8A]/10"
        ...
        <article className="tkf-card p-5">
          ...
          <div className="space-y-2">
            {recurringFailures.length === 0 ? (
              <div className="tkf-empty">Nenhuma falha recorrente no perÃ­odo selecionado.</div>
          ...
          <div className="space-y-2">
            {filteredRecords.slice(0, 6).map((record) => (
              <div key={record.id} className="rounded-xl border border-slate-200 bg-slate-50 px-3 py-2 text-xs">
                ...
                <p className="text-slate-600">{record.item} â€¢ {record.status} â€¢ {record.operador}</p>
              </div>
            ))}
